...
socket.on("usuarios_no_documento", atualizarInterfaceUsuario)

function emitTextoEditor(dados) {
...
export {emitTextoEditor, selecionarDocumento, emitirExcluirDocumento};